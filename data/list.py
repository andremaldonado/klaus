...
def _get_list_ref(chat_id: str, list_name: str):
    logger.debug(f"▶️ [DEBUG] Getting list reference for chat_id: {chat_id}, list_name: {list_name}")
...
def _get_items_ref(chat_id: str, list_name: str):
    logger.debug(f"▶️ [DEBUG] Getting items reference for chat_id: {chat_id}, list_name: {list_name}")
...
def get_list(chat_id: str, list_name: str) -> list[dict]:
    logger.debug(f"▶️ [DEBUG] Fetching list: {list_name} for chat_id: {chat_id}")
